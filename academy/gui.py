...
class Gui(tk.Frame):
    ...
    def draw(self):
        ...
        if utils.state != 7:  # no setting
            ...
            if utils.reading_tags == 0:
                self.tags_on_off1 = ttk.Button(self, text='Tag read AUTO = OFF', command=self.tags_on_off1_button,
                                               style='red.TButton')
                self.tags_on_off2 = ttk.Button(self, text='Tag read DAY = OFF', command=self.tags_on_off2_button,
                                               style='red.TButton')
                self.tags_on_off3 = ttk.Button(self, text='Tag read NIGHT = OFF', command=self.tags_on_off3_button,
                                               style='red.TButton')
            elif utils.reading_tags == 1:
                self.tags_on_off1 = ttk.Button(self, text='Tag read AUTO = ON', command=self.tags_on_off1_button,
                                               style='green.TButton')
                self.tags_on_off2 = ttk.Button(self, text='Tag read DAY = OFF', command=self.tags_on_off2_button,
                                               style='red.TButton')
                self.tags_on_off3 = ttk.Button(self, text='Tag read NIGHT = OFF', command=self.tags_on_off3_button,
                ...
                self.tags_on_off1 = ttk.Button(self, text='Tag read AUTO = OFF', command=self.tags_on_off1_button,
                                               style='red.TButton')
                self.tags_on_off2 = ttk.Button(self, text='Tag read DAY = ON', command=self.tags_on_off2_button,
                                               style='green.TButton')
                self.tags_on_off3 = ttk.Button(self, text='Tag read NIGHT = OFF', command=self.tags_on_off3_button,
                                               style='red.TButton')
            else:
                ...
                self.tags_on_off2 = ttk.Button(self, text='Tag read DAY = OFF', command=self.tags_on_off2_button,
                                               style='red.TButton')
                self.tags_on_off3 = ttk.Button(self, text='Tag read NIGHT = ON', command=self.tags_on_off3_button,
                                               style='red.TButton')
            ...
            ttk.Separator(self, orient=tk.HORIZONTAL).place(x=x1-10, y=70, height=4, width=190)

            # camera button
            self.cams_on_off = ttk.Button(self, text='Preview Cams', command=self.cams_on_off_button,
                                          style='green.TButton')
            self.cams_on_off.place(x=x1, y=74, height=20, width=160)

            ttk.Separator(self, orient=tk.HORIZONTAL).place(x=x1 - 10, y=94, height=4, width=190)

            # doors
            ttk.Button(self, text='Open door 1', command=self.open_door1,
                       style='green.TButton').place(x=x1, y=98, height=20, width=160)
            ttk.Button(self, text='Close door 1', command=self.close_door1,
                       style='red.TButton').place(x=x1, y=118, height=20, width=160)
            ttk.Button(self, text='Open door 2', command=self.open_door2,
                       style='green.TButton').place(x=x1, y=138, height=20, width=160)
            ttk.Button(self, text='Close door 2', command=self.close_door2,
                       style='red.TButton').place(x=x1, y=158, height=20, width=160)
            ttk.Button(self, text='Open inner door', command=self.open_inner_door,
                       style='green.TButton').place(x=x1, y=178, height=20, width=160)
            ttk.Button(self, text='Close inner door', command=self.close_inner_door,
                       style='red.TButton').place(x=x1, y=198, height=20, width=160)

            ttk.Separator(self, orient=tk.HORIZONTAL).place(x=x1 - 10, y=118, height=4, width=190)

            # buzzer
            ttk.Button(self, text='Play buzzer 1', command=self.play_buzzer1,
                       style='blue.TButton').place(x=x1, y=222, height=20, width=160)
            ttk.Button(self, text='Play buzzer 2', command=self.play_buzzer2,
                       style='blue.TButton').place(x=x1, y=242, height=20, width=160)

            ttk.Separator(self, orient=tk.HORIZONTAL).place(x=x1 - 10, y=262, height=4, width=190)

            # temperature
            ttk.Button(self, text='Get temperature', command=self.get_temperature,
                       style='blue.TButton').place(x=x1, y=266, height=20, width=160)

            ttk.Separator(self, orient=tk.HORIZONTAL).place(x=x1 - 10, y=290, height=4, width=190)

            # scale
            ttk.Button(self, text='Tare scale', command=self.tare_scale,
                       style='blue.TButton').place(x=x1, y=294, height=20, width=160)
            ttk.Button(self, text='Get weight', command=self.get_weight,
                       style='blue.TButton').place(x=x1, y=314, height=20, width=160)

            ttk.Separator(self, orient=tk.HORIZONTAL).place(x=x1 - 10, y=334, height=4, width=190)

            # x_max
            ttk.Button(self, text='+ days', command=self.x_max_bigger,
                       style='green.TButton').place(x=x1+80, y=338, height=20, width=80)
            ttk.Button(self, text='- days', command=self.x_max_smaller,
                       style='red.TButton').place(x=x1, y=338, height=20, width=80)

            # threshold_max
            ttk.Button(self, text='+ thresh', command=self.threshold_bigger,
                       style='green.TButton').place(x=x3+80, y=308, height=20, width=80)
            ttk.Button(self, text='- thresh', command=self.threshold_smaller,
                       style='red.TButton').place(x=x3, y=308, height=20, width=80)

            # plots button
            self.upload_button = ttk.Button(self, text='Update plots (' + str(utils.x_max) + ' days)',
                                            command=self.update_canvas, style='blue.TButton')
            ...
            for task in task_collection.tasks:
                button = ttk.Button(self, text=task.task, command=partial(self.task_action, task.task),
                                    style='blue.TButton')
            ...
            # subject info
            self.subject_button = ttk.Button(self, text='ADD SUBJECT INFO', command=self.add_subject_info,
                                             style='blue.TButton')
            ...
            self.subject_button2 = ttk.Button(self, text='', command=self.add_subject_info2,
                                             style='blue.TButton', state='disabled')
            self.subject_button2.place(x=x3, y=150, width=160, height=20)

            # reload tasks
            self.reload_button = ttk.Button(self, text='RELOAD ACADEMY', command=self.reload_tasks,
                                            style='red.TButton')
            self.reload_button.place(x=x3, y=250, width=160, height=20)

            # exit task
            self.exit_button = ttk.Button(self, text='EXIT TASK', command=self.exit_task, style='red.TButton',
                                          state='disabled')
            ...
            tk.Label(self, text='', anchor='w', width=first_cell).grid(row=row, column=1)
            ...
            # name of task
            tk.Label(self, text=utils.gui_name, anchor='w', width=all_no_margins).grid(row=row, column=1, columnspan=11)
            row += 1
            ttk.Separator(self, orient=tk.HORIZONTAL).grid(row=row, column=1, columnspan=11, sticky='ew')
            row += 1
            ...
            if utils.task.info is not None:
                tk.Label(self, text=str(utils.task.info), anchor='w',
            ...
            tk.Label(self, text='subject', anchor='e', width=first_cell).grid(row=row, column=1)
            ...
            for name in all_inputs_and_outputs:
                ...
                if type(attribute) == bool:
                    ...
                    var = tk.BooleanVar()
                    var.set(attribute)
                    tk.Label(self, text=name, anchor='e', width=first_cell).grid(row=row, column=1)
                    ...
                    if len(attribute) <= 10:
                        ...
                        for i in range(len(attribute)):
                            tk.Label(self, text=str(i + 1), anchor='w', width=margin).grid(row=row, column=i + 2)
                        row += 1
                        ...
                        tk.Label(self, text=mytext, anchor='w',
                              width=all_no_margins).grid(row=row, column=1, columnspan=11)
                        run_task_flag = False
                        row += 1
                else:
    ...
    def run_task(self):
        ...
        try:
            ...
            self.subject = utils.subjects.read_last_value_excluding('name', self.subject_name,
                                                                    'task', ['manual_water',
                                                                             'control_weight',
                                                                             'basal_weight'])
    ...
    def update_events(self):
        if utils.state != 7:
            ...
            for event in last_events:
                ...
                text = event.date + '     ' + str(event.subject) + '     ' + str(event.description)
                if event.type == 'ERROR':
                    label['fg'] = 'red'
    ...
    def threshold_bigger(self):
        cam3.put_state("plus")

    def threshold_smaller(self):
        cam3.put_state("minus")
    ...
    def add_subject_data(self, subject, task, value, value2):
        try:
            subject_item = utils.subjects.read_last_value_excluding('name', subject,
                                                                    'task',
            ...
            if task == 'Add control weight':
                utils.subjects.add_new_item({'task': 'control_weight',
                                             'stage': 0.0,
                                             'substage': 0.0,
                                             'wait_seconds': 0.0,
                                             'weight': value,
                                             'water': 0.0}, item=subject_item)
            elif task == 'Add basal weight':
                utils.subjects.add_new_item({'task': 'basal_weight',
                                             'stage': 0.0,
                                             'substage': 0.0,
                                             'wait_seconds': 0.0,
                                             'weight': value,
                ...
                utils.subjects.add_new_item({'task': 'manual_water',
                                             'stage': 0.0,
                                             'substage': 0.0,
                                             'wait_seconds': 0.0,
                                             'weight': 0.0,
                                             'water': value}, item=subject_item)
            else:
                value2 = float(value2)
                utils.subjects.add_new_item({'name': subject,
                                             'water': 0.0,
                                             'task': task,
                                             'stage': value,
                                             'substage': value2,
                                             'wait_seconds': 0.0}, item=subject_item)
