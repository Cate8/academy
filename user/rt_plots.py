...
def read_dataframes(init_time, final_time):
    ...
    subjects['perc_weight'] = subjects['weight'] / pd.to_numeric(subjects['basal_weight']) * 100
...
def rt_plot(init_time, final_time):
    ...
    try:
        ...
        df = weight_df[['day', 'subject', 'perc_weight']].groupby(['day', 'subject']).median()
    ...
    try:
        ...
        df = water_df[['day', 'subject', 'water']].groupby(['day', 'subject']).sum()
