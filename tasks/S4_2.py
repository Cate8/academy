...
class S4_2(Task):
    ...
    def init_variables(self):
        ...
        self.N_blocks = 100
        self.prob_right_values = [0.9]  # if you want the prob_Right to be ONLY 0.8 and 0.2, then make this list prob_right_values = [0.8]
        ...
        def custom_random_iti(num_trials, num_values_per_trial):
            lambda_parameter = 0.5  # lambda for exp distribution
