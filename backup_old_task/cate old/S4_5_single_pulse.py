...
this version has the limitation of light on, most of the trials with iti > 6 sec (OPTO ONSET) will have light on generating a 
wery low number of trials with iti duration > 6 with light off. 
